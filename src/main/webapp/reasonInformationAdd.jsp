...
<body>
	...
	<main class="container-fluid">
		...
		<br /> <br />
		<form action="ReasonAllServlet" method="post">
			...
			<label>DATE : </label> <input type="date" name="date" id="date"
				...
				required> <br /> <br /> <label>TYPE : </label><br /> <label
				for="absent"> <input type="radio" id="absent"
				name="attendanceType" value="ABSENT" required> ABSENT
				...
				value="<%=facultyEmailId%>" required><br /> <br /> <label>REASON
